...
int BinTreeAddNode(ChainBinTree* bt, ChainBinTree* node,
                   int n) //添加数据到二叉树
...
int BinTreeIsEmpty(ChainBinTree*
...
ChainBinTree* BinTreeFind(ChainBinTree* bt,
...
void BinTreeClear(ChainBinTree*
                  bt) // 清空二叉树，使之变为一棵空树
{
    if (bt) {
