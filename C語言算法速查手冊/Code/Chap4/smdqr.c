...
int n, itmax;
{
    ...
    if (is1 > 0 &&
        ...
        smdqr(a1, n1, u + is1, eps,
              itmax); /* 递归调用函数求解最后一块矩阵*/
        free(a1);
        return (1);
    } else if (is1  == n) {
        return (1);
